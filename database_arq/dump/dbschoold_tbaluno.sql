...
CREATE TABLE `tbaluno` (
  ...
  `nrbi` varchar(12) NOT NULL,
  `genero` enum('Masculino','Feminino') DEFAULT NULL,
  `idade` int NOT NULL,
  `telefone` varchar(15) DEFAULT NULL,
  `naturalidade` varchar(50) NOT NULL DEFAULT 'Maputo',
  `categcarta` int NOT NULL,
  `datamatricula` date NOT NULL,
  `turma` int NOT NULL,
  PRIMARY KEY (`cod`),
  UNIQUE KEY `telefone` (`telefone`),
  KEY `categcarta` (`categcarta`),
  KEY `turma` (`turma`),
  CONSTRAINT `tbaluno_ibfk_1` FOREIGN KEY (`categcarta`) REFERENCES `tbclassec` (`cod`),
  CONSTRAINT `tbaluno_ibfk_2` FOREIGN KEY (`turma`) REFERENCES `tbturma` (`cod`)
...
-- Dump completed on 2022-04-30 15:33:48
